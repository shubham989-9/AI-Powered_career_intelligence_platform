      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <InfoCard title="Phone" value={profile.phone} icon={Phone} />
            <InfoCard title="City" value={profile.city} icon={MapPin} />
            <InfoCard title="Country" value={profile.country} icon={Globe} />
            <InfoCard title="LinkedIn" value={profile.linkedin} icon={LinkIcon} />
            <InfoCard title="GitHub" value={profile.github} icon={LinkIcon} />
            <InfoCard title="College" value={profile.college} icon={GraduationCap} />
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <InfoCard title="Branch" value={profile.branch} />
              <InfoCard title="Passing Year" value={profile.passing_year} />
              <InfoCard title="CGPA" value={profile.cgpa} />
            </div>
          </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl">
            ...
            <div className="space-y-4">
              <InfoCard title="Skills" value={profile.skills} />
              <InfoCard title="Experience" value={profile.experience} />
            </div>
          </div>
        </div>
            ...
            <div className="bg-slate-900 rounded-3xl w-full max-w-5xl max-h-[90vh] overflow-y-auto border border-slate-700 shadow-2xl">
              <div className="flex justify-between items-center p-6 border-b border-slate-800 sticky top-0 bg-slate-900 z-10">
                <h2 className="text-2xl font-bold text-white flex items-center gap-3">
                  <Pencil className="text-cyan-400" /> Edit Profile
                </h2>
