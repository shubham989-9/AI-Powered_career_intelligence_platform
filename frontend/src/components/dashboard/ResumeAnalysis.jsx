...
function ResumeAnalysis() {
    ...
    try {
      ...
      if (replaceResumeId) {
        response = await api.put(
          `/resume/replace/${replaceResumeId}`,
          formData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  return (
    ...
    >
      ...
      <div className="absolute blur-[180px] w-[400px] h-[400px] bg-violet-500/10 rounded-full top-20 left-20" />

      <div className="absolute blur-[180px] w-[300px] h-[300px] bg-cyan-500/10 rounded-full bottom-20 right-20" />
              ...
              <div className="grid lg:grid-cols-[280px_1fr] gap-6">
                ...
                <div className="rounded-3xl bg-[#10172D] border border-slate-700 p-7">
                  ...
                  <div className="space-y-4">
                    ...
                    {selectedResume?.suggestions?.map(
                      (item, index) => (
                        <motion.div
                          key={index}
                          initial={{
